 ...
 * @since 4.2
 */
public class NewForm extends Form implements INewForm {
    ...
    public void fromXML(Object obj) {
        ...
        Iterator iterator = XMLUtil.getChildElements(element, IDatasetConstant.ADD_FIELD).iterator();
        while (iterator.hasNext()) {
            Element elem = (Element) iterator.next();
            IAddField field = new AddField();
    ...
    public Element toXML(Document document) {
        Element element = XMLUtil.createElement(document,IDatasetConstant.ADD_FORM);
